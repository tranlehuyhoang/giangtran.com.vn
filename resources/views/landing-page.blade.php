...
{{--
                ...
                <div class="container">
                    <a class="navbar-brand logo" href="/">
                        <img src="/logo/giangtran.com.vn.png" alt="image" class="logo__img" style="width: 145px;"
                            srcset="/logo/giangtran.com.vn.png 300w,
                                /logo/giangtran.com.vn.png 600w,
                                /logo/giangtran.com.vn.png 1200w"
                                        ...
                                        <a href="/home"
                                            ...
                                            <span class="flex-grow-1">
                                                ...
                                                <span class="contain-sub-1__description">
                                                    Chạy Trên Nền Cpanel Tối Ưu Hóa Mạnh Mẽ
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="/home"
                                            ...
                                            <span class="flex-grow-1">
                                                ...
                                                <span class="contain-sub-1__description">
                                                    Máy Chủ Việt Nam Mạnh Mẽ, Anti DDoS
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="/home"
                                            ...
                                            <span class="flex-grow-1">
                                                ...
                                                <span class="contain-sub-1__description">
                                                    Máy Chủ Canada Mạnh Mẽ, Tối Ưu Hóa Trang Web
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="/home"
                                            ...
                                            <span class="flex-grow-1">
                                                ...
                                                <span class="contain-sub-1__description">
                                                    Máy Chủ Đức Mạnh Mẽ, Anti DDoS, Miễn Phí
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="/home"
                                            ...
                                            <span class="flex-grow-1">
                                                ...
                                                <span class="contain-sub-1__description">
                                                    Phù Hợp Với Đại Lý Nhỏ Lẻ, Trãi Nghiệm
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="dedicated-server.html"
                                            ...
                                            <span class="flex-grow-1">
                                                ...
                                                <span class="contain-sub-1__description">
                                                    Máy Chủ Vật Lý Tài Nguyên Riêng Biệt
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                        ...
                                        <div class="row g-0 align-items-center">
                                            <div class="col-xl-7">
                                                <div class="h-100 pt-32 pb-32 px-6">
                                                    <span class="h6 d-block fs-18"> Tên Miền </span>
                                    ...
                                    <li>
                                        <a href="/dieu-khoan"
                                            ...
                                            <span class="flex-grow-1">
                                                ...
                                                <span class="contain-sub-1__description">
                                                    Một Số Điều Khoản & Chính Sách Quyền Lợi Khách Hàng Nên Đọc.
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                        ...
                        <div class="position-relative z-1">
                            ...
                            <div class="hero-1__map">
                                <img class="img-fluid hero-1__map-img"
                                    ...
                                    srcset="/assets/static/assets/img/shape/hero-map.webp 300w,
                                        /assets/static/assets/img/shape/hero-map.webp 600w,
                                        /assets/static/assets/img/shape/hero-map.webp 1200w"
                                    sizes="(max-width: 600px) 300px, (max-width: 1024px) 600px, 1200px">
        ...
        <section class="price-area-2 pt-120 pb-60 position-relative z-1">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="tab-content" data-sal="fade" data-sal-duration="500" data-sal-delay="300"
                            data-sal-easing="ease-in-out-sine">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        <div
                                                ...
                                                <div class="mt-5">
                                                    <div class="monthly-price">
                                                        <div
                                                            ...
                                                            <del class="fw-bold text-body"> 100,000đ </del>
                                                            <span
                                                                class="badge rounded-pill bg-primary-subtle text-primary-emphasis">
                                                                50% </span>
                                                        </div>
                                                        <h4 class="mb-0"> 50,000đ </h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <a class="btn btn-dark btn-arrow btn-lg w-100 fs-14 fw-bolder rounded mt-6"
                                            ...
                                            <div class="mt-6">
                                                ...
                                                <ul
                                                    class="price-service-wrapper list-unstyled d-flex flex-column gap-3 mb-0">
                                                    <li class="d-flex align-items-center gap-3">
                                                        <div
                                                            class="w-4 h-4 bg-success rounded-circle fs-12 text-white d-flex align-items-center justify-content-center">
                                                            <i class="las la-check"></i>
                                            ...
                                            <div class="text-center">
                                                ...
                                                <div class="mt-5">
                                                    <div class="monthly-price">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center gap-2 mb-3">
                                                            <del class="fw-bold text-body"> 200,000đ </del>
                                                            <span
                                                                class="badge rounded-pill bg-primary-subtle text-primary-emphasis">
                                                                50% </span>
                                                        </div>
                                                        <h4 class="mb-0"> 100,000đ </h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <a class="btn btn-dark btn-arrow btn-lg w-100 fs-14 fw-bolder rounded mt-6"
                                            ...
                                            <div class="text-center">
                                                ...
                                                <div class="mt-5">
                                                    <div class="monthly-price">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center gap-2 mb-3">
                                                            <del class="fw-bold text-body"> 699,000đ </del>
                                                            <span
                                                                class="badge rounded-pill bg-primary-subtle text-primary-emphasis">
                                                                57.22% </span>
                                                        </div>
                                                        <h4 class="mb-0"> 299,000đ </h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <a class="btn btn-dark btn-arrow btn-lg w-100 fs-14 fw-bolder rounded mt-6"
                                                ...
                                                <div class="mt-5">
                                                    <div class="monthly-price">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center gap-2 mb-3">
                                                            <span
                                                                class="badge rounded-pill bg-primary-subtle text-primary-emphasis">Save
                                                                15%</span>
                                                        </div>
                                                        <h4 class="mb-0"> 3,000đ </h4>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-xl-4">
                        <p class="text-white" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300"
                            data-sal-easing="ease-in-out-sine"> Tặng SSL Tiêu Chuẩn, Tên Miền, VPS 1 Năm Khi Thiết Kế
                            Website Tại HG DIGITAL Hoàn Toàn Miễn Phí. </p>
                    </div>
                </div>
                <div class="mt-8">
                    <div class="row g-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4">
                            <div class="why-service-item last text-center position-relative" data-sal="slide-up"
                                ...
                                <h5 class="text-white mb-3"><span class="counter"> 10,000 </span> Thành Viên </h5>
                                <p class="text-white text-opacity-75"> Hơn 10,000 Thành Viên Nify. </p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="pt-60 pb-60">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <h2 data-sal="slide-up" data-sal-duration="500" data-sal-delay="200"
                            data-sal-easing="ease-in-out-sine" class="sal-animate">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;"> Feedback Từ Khách Hàng </font>
                            </font>
                        </h2>
                    </div>
                </div>
                <div class="mt-8 position-relative sal-animate" data-sal="fade" data-sal-duration="1500"
                    data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                    <div class="feedback-slider swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                        <div class="swiper-wrapper" id="swiper-wrapper-fdf291bef7c45d11" aria-live="off"
                                ...
                                <div class="bg-white p-7 shadow-sm rounded-3">
                                    ...
                                    <p class="mt-3">
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">Điều tuyệt vời nhất mà chúng tôi
                                                thích ở
                                                Hg Digital là nó đồng bộ hai chiều với Google Apps. Nó giúp chúng tôi
                                                sắp
                                                xếp mọi
                                    ...
                                    <div class="d-flex align-items-center gap-4 mt-7">
                                        ...
                                        <div>
                                            <h6 class="fs-16 mb-0">
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">Lola Ross</font>
                                                </font>
                                            </h6>
                                            <small>
                                                <font style="vertical-align: inherit;">
                            ...
                            <div class="swiper-slide swiper-slide-active" role="group" aria-label="3 / 4"
                                data-swiper-slide-index="2" style="width: 416px; margin-right: 24px;">
                                <div class="bg-white p-7 shadow-sm rounded-3">
                                    <div
                                        class="d-flex align-items-center justify-content-between border-bottom border-secondary pb-5">
                            ...
                            <div class="swiper-slide swiper-slide-next" role="group" aria-label="4 / 4"
                                data-swiper-slide-index="3" style="width: 416px; margin-right: 24px;">
                                <div class="bg-white p-7 shadow-sm rounded-3">
                                    <div
                                        class="d-flex align-items-center justify-content-between border-bottom border-secondary pb-5">
                                        <img src="/assets/static/assets/img/feedback-brand-3.png" alt="hình ảnh"
                    ...
                    <div
                        class="feedback-navs d-flex align-items-center justify-content-between position-relative w-100 z-2 d-none d-md-flex">
                        <span
                        ...
                        <span
                            ...
                            aria-controls="swiper-wrapper-fdf291bef7c45d11"><i class="las la-arrow-left"></i></span>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <div class="ps-xl-5">
                            ...
                            <ul class="list-unstyled d-flex flex-column gap-2">
                                ...
                                <li><a href="https://www.facebook.com/profile.php?id=61569955093836"
                                        class="footer-2-link">Liên hệ với chúng
                                        tôi</a></li>
                            </ul>
                        </div>
                    </div>

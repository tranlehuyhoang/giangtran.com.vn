                ...
                <table class="table display" id="selling-product" style="width:100%">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/project/1.png" alt=""></div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/project/2.png" alt=""></div>
                          <div class="flex-grow-1 ms-2"><a href="product-page.html">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/project/3.png" alt=""></div>
                          <div class="flex-grow-1 ms-2"><a href="product-page.html">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/project/4.png" alt=""></div>
                          <div class="flex-grow-1 ms-2"><a href="product-page.html">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul class="notification-box">
                <li class="d-flex"> 
                  <div class="flex-shrink-0 bg-light-primary"><img src="/mofi/assets/images/dashboard/icon/wallet.png" alt="Wallet"></div>
                ...
                <li class="d-flex"> 
                  <div class="flex-shrink-0 bg-light-info"><img src="/mofi/assets/images/dashboard/icon/shield-dne.png" alt="Shield-dne"></div>
                  <div class="flex-grow-1"> <a href="private-chat.html">
                ...
                <li class="d-flex"> 
                  <div class="flex-shrink-0 bg-light-warning"> <img src="/mofi/assets/images/dashboard/icon/graph.png" alt="Graph"></div>
                  <div class="flex-grow-1"> <a href="private-chat.html">
                ...
                <li class="d-flex"> 
                  <div class="flex-shrink-0 bg-light-tertiary"><img src="/mofi/assets/images/dashboard/icon/ticket-star.png" alt="Ticket-star"></div>
                  <div class="flex-grow-1"> <a href="private-chat.html">
                ...
                <div class="col-5"> 
                  <ul class="appointments-user">
                    <li class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/user/05.png" alt=""></div>
                      <div class="flex-grow-1"><a href="private-chat.html">
                          <h5>John Elliot</h5></a>
                    ...
                    <li class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/user/06.png" alt=""></div>
                      <div class="flex-grow-1"><a href="private-chat.html">
                          <h5>Ashley Hart</h5></a>
                    ...
                    <li class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/user/07.png" alt=""></div>
                      <div class="flex-grow-1"><a href="private-chat.html">
                    ...
                    <li class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/user/08.png" alt=""></div>
                      <div class="flex-grow-1"><a href="private-chat.html">
                          <h5>Dana Lemon</h5></a>
                ...
                <table class="table display" style="width:100%">
                  ...
                  <tbody>   
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/user/01.jpg" alt=""></div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/user/02.jpg" alt=""></div>
                          <div class="flex-grow-1"><a href="product.html">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/user/03.jpg" alt=""></div>
                          <div class="flex-grow-1"><a href="product.html">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/user/04.jpg" alt=""></div>
                          <div class="flex-grow-1"><a href="product.html">
              ...
              <div class="row"> 
                <div class="col-3 statistic-icon">    
                  <div class="light-card balance-card widget-hover">
                    <div class="icon-box"><img src="/mofi/assets/images/dashboard/icon/customers.png" alt=""></div>
                ...
                <div class="col-3 statistic-icon"> 
                  <div class="light-card balance-card widget-hover">
                    <div class="icon-box"><img src="/mofi/assets/images/dashboard/icon/revenue.png" alt=""></div>
                ...
                <div class="col-3 statistic-icon">
                  <div class="light-card balance-card widget-hover">
                    <div class="icon-box"><img src="/mofi/assets/images/dashboard/icon/profit.png" alt=""></div>
                ...
                <table class="table display" style="width:100%">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/product/1.png" alt=""></div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/product/2.png" alt=""></div>
                          <div class="flex-grow-1"><a href="list-products.html">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/product/3.png" alt=""></div>
                          <div class="flex-grow-1"><a href="list-products.html">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/product/4.png" alt=""></div>
                          <div class="flex-grow-1"><a href="list-products.html">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard/product/5.png" alt=""></div>
                          <div class="flex-grow-1"><a href="list-products.html">

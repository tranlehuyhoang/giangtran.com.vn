                                    ...
                                    <div class="theme-form mt-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-input">
                                                <input class="form-control" type="password" name="login[password]"
                                                    id="password" placeholder="*********" style="background-color: white;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="checkbox p-0">
                                                ...
                                                <label class="text-muted" for="dieuKhoan"> Đồng Ý</label> <a
                                                    href="/dieu-khoan" class="txt-primary"> Điều Khoản & Chính Sách </a>
                                            </div>
                                            ...
                                            <div class="text-end mt-3">
                                                <button class="btn btn-dark btn-block w-100" type="submit"
                                                    onclick="register('btn', 'Tạo Tài Khoản')" id="btn"> Tạo Tài Khoản
                                                </button>
                                            </div>
                                        </div>
    
                                        <p class="mt-4 mb-0 text-center"> Đã Có Tài Khoản?<a class="ms-2" href="/login">
                                                Đăng Nhập </a></p>
                                    </div>
                                </div>
                            </div>

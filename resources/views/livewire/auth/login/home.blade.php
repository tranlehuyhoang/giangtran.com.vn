      ...
      <div class="login-card login-dark">
        <div>
          <div><a class="logo" href="index.html"><img class="img-fluid for-light"
                src="/mofi/assets/images/logo/logo.png" alt="looginpage"><img class="img-fluid for-dark"
                src="/mofi/assets/images/logo/logo_dark.png" alt="looginpage"></a></div>
          <div class="login-main">
            <form class="theme-form">
              ...
              <div class="form-group mb-0">
                ...
                <a class="link" href="{{ route('auth.forget-password') }}" wire:navigate>Forgot password?</a>
              ...
              <p class="mt-4 mb-0 text-center">Don't have an account?
                <a class="ms-2" href="{{ route('auth.register') }}" wire:navigate>Create Account</a>
              </p>

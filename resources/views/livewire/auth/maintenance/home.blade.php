<div>
  ...
  <head>
    <title>Maintenance | Mofi - Premium Admin Template By Pixelstrap</title>
  ...
  <div class="page-wrapper">
    ...
    <div class="error-wrapper maintenance-bg">
      <div class="container">
        ...
        <div><a class="btn btn-primary-gradien btn-lg text-light" href="index.html">BACK TO HOME PAGE</a></div>
      </div>
    </div>
    <!-- Maintenance end-->
  </div>

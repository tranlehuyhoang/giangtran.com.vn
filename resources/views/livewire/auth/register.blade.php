                                    ...
                                    <div class="theme-form mt-3">
                                        ...
                                        <form wire:submit.prevent="register">
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <input class="form-control {{ isset($errors['username']) ? 'is-invalid' : '' }}" type="text" wire:model="username"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-input">
                                                    <input class="form-control {{ isset($errors['password']) ? 'is-invalid' : '' }}" type="password" wire:model="password"
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="checkbox p-0">
                                                    ...
                                                    <a href="/dieu-khoan" class="txt-primary"> Điều Khoản & Chính Sách </a>
                                                </div>
                                                ...
                                                <div class="text-end mt-3">
                                                    <button class="btn btn-dark btn-block w-100"> Tạo Tài Khoản </button>
                                                </div>
                                                <hr class="my-3">
                                                ...
                                                <div class="mt-2">
                                                    <button onclick="window.location.href='{{ route('google.login') }}'" class="btn btn-warning btn-block w-100" type="button"
                                                        id="loginWithGoogle"  >

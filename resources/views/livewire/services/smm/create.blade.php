                                                    ...
                                                    <div class="card title-line">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="domain" placeholder="Chọn Danh Mục">
                                                            </div>
                                                            ...
                                                            <div class="form-group mt-3">
                                                                ...
                                                                <input class="form-control" id="email" placeholder="Chọn Dịch Vụ" value="">
                                                            </div>
                                                            <div class="form-group mt-3">
                                                                <label> Link </label>
                                                                <input type="hidden" id="cycle_max" value="12">
                                                                <input class="form-control" id="domain" placeholder="Link">
                                                            </div>
                                                            <div class="form-group mt-3">

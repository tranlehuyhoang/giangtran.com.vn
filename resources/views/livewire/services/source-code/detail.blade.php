<div>
    ...
    <head>
        @livewire('inc.seo', ['title' => 'Chi Tiết Mã Nguồn'])



        <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
        <link rel="stylesheet" href="/assets/static/style.css?v=1431624358">
    ...
    <body id="content">
        ...
        <script src="/assets/static/invoices.js?v=1731410724" defer></script>

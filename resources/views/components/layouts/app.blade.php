...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/mofi/assets/css/vendors/datatables.css">
    <link rel="stylesheet" type="text/css" href="/mofi/assets/css/vendors/date-range-picker/flatpickr.min.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
  ...
  <body> 
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      <div class="page-header row">
        <div class="header-logo-wrapper col-auto">
          <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="/mofi/assets/images/logo/logo.png" alt=""/><img class="img-fluid for-dark" src="/mofi/assets/images/logo/logo_light.png" alt=""/></a></div>
        </div>
        ...
        <div class="header-wrapper col m-0">
          <div class="row">
            ...
            <div class="header-logo-wrapper col-auto p-0">
              <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="/mofi/assets/images/logo/logo.png" alt=""></a></div>
            ...
            <div class="nav-right col-xxl-8 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
              <ul class="nav-menus">
                <li>                         <span class="header-search">
                    <svg>
                      <use href="/mofi/assets/svg/icon-sprite.svg#search"></use>
                    </svg></span></li>
                <li>
                  <div class="form-group w-100">
                    <div class="Typeahead Typeahead--twitterUsers">
                ...
                <li class="fullscreen-body">                       <span>
                    <svg id="maximize-screen">
                      <use href="/mofi/assets/svg/icon-sprite.svg#full-screen"></use>
                    </svg></span></li>
                <li class="onhover-dropdown">
                  <div class="notification-box">
                    <svg>
                      <use href="/mofi/assets/svg/icon-sprite.svg#notification"></use>
                  ...
                  <div class="onhover-show-div notification-dropdown">
                    ...
                    <ul class="notification-box">
                      <li class="toast default-show-toast align-items-center border-0 fade show" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
                        <div class="d-flex justify-content-between">
                          <div class="toast-body d-flex p-0">
                            <div class="flex-shrink-0 bg-light-primary"><img class="w-auto" src="/mofi/assets/images/dashboard/icon/wallet.png" alt="Wallet"></div>
                      ...
                      <li class="toast default-show-toast align-items-center border-0 fade show" aria-live="assertive" aria-atomic="true" data-bs-autohide="false"> 
                        <div class="d-flex justify-content-between">
                          <div class="toast-body d-flex p-0">
                            <div class="flex-shrink-0 bg-light-info"><img class="w-auto" src="/mofi/assets/images/dashboard/icon/shield-dne.png" alt="Shield-dne"></div>
                            <div class="flex-grow-1"> <a href="private-chat.html">
                      ...
                      <li class="toast default-show-toast align-items-center border-0 fade show" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">  
                        <div class="d-flex justify-content-between">
                          <div class="toast-body d-flex p-0">
                            <div class="flex-shrink-0 bg-light-warning"><img class="w-auto" src="/mofi/assets/images/dashboard/icon/graph.png" alt="Graph"></div>
                            <div class="flex-grow-1"> <a href="private-chat.html">
                      ...
                      <li class="toast default-show-toast align-items-center border-0 fade show" aria-live="assertive" aria-atomic="true" data-bs-autohide="false"> 
                        <div class="d-flex justify-content-between"> 
                          <div class="toast-body d-flex p-0">
                            <div class="flex-shrink-0 bg-light-tertiary"><img class="w-auto" src="/mofi/assets/images/dashboard/icon/ticket-star.png" alt="Ticket-star"></div>
                            <div class="flex-grow-1"> <a href="private-chat.html">
                ...
                <li class="onhover-dropdown">
                  <svg>
                    <use href="/mofi/assets/svg/icon-sprite.svg#header-bookmark"></use>
                  </svg>
                ...
                <li>
                  <div class="mode">
                    <svg>
                      <use href="/mofi/assets/svg/icon-sprite.svg#moon"></use>
                    </svg>
                  </div>
                </li>
                <li class="onhover-dropdown">
                  <div class="notification-box">
                    <svg>
                      <use href="/mofi/assets/svg/icon-sprite.svg#header-message"></use>
                  ...
                  <div class="onhover-show-div notification-dropdown">
                    ...
                    <ul class="messages">
                      <li class="d-flex b-light1-primary gap-2"> 
                        <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard-2/user/1.png" alt="Graph"></div>
                        <div class="flex-grow-1"> <a href="private-chat.html">
                      ...
                      <li class="d-flex b-light1-secondary gap-2"> 
                        <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard-2/user/2.png" alt="Graph"></div>
                        <div class="flex-grow-1"> <a href="private-chat.html">
                      ...
                      <li class="d-flex b-light1-success gap-2"> 
                        <div class="flex-shrink-0"><img src="/mofi/assets/images/dashboard-2/user/3.png" alt="Graph"></div>
                        <div class="flex-grow-1"> <a href="private-chat.html">
                ...
                <li class="cart-nav onhover-dropdown">
                  ...
                  <div class="cart-dropdown onhover-show-div">
                    ...
                    <ul>
                      <li>
                        <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="/mofi/assets/images/other-images/cart-img.jpg" alt="">
                      ...
                      <li>
                        <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="/mofi/assets/images/other-images/table-img.jpg" alt="">
                ...
                <li class="profile-nav onhover-dropdown px-0 py-0">
                  <div class="d-flex profile-media align-items-center"><img class="img-30" src="/mofi/assets/images/dashboard/profile.png" alt="">
   ...
   @livewire('inc.footer')
    ...
    <script src="/mofi/assets/js/chart/apex-chart/apex-chart.js"></script>
    <script src="/mofi/assets/js/chart/apex-chart/stock-prices.js"></script>
    <script src="/mofi/assets/js/chart/apex-chart/moment.min.js"></script>
    <script src="/mofi/assets/js/notify/bootstrap-notify.min.js"></script>
    <!-- calendar js-->
    <script src="/mofi/assets/js/dashboard/default.js"></script>
    <script src="/mofi/assets/js/notify/index.js"></script>
    <script src="/mofi/assets/js/datatable/datatables/jquery.dataTables.min.js"></script>
    <script src="/mofi/assets/js/datatable/datatables/datatable.custom.js"></script>
    <script src="/mofi/assets/js/datatable/datatables/datatable.custom1.js"></script>
    <script src="/mofi/assets/js/datepicker/date-range-picker/moment.min.js"></script>
    <script src="/mofi/assets/js/datepicker/date-range-picker/datepicker-range-custom.js"></script>
    <script src="/mofi/assets/js/typeahead/handlebars.js"></script>
    <script src="/mofi/assets/js/typeahead/typeahead.bundle.js"></script>
    <script src="/mofi/assets/js/typeahead/typeahead.custom.js"></script>
    <script src="/mofi/assets/js/typeahead-search/handlebars.js"></script>
    <script src="/mofi/assets/js/typeahead-search/typeahead-custom.js"></script>
    <script src="/mofi/assets/js/height-equal.js"></script>
    <script src="/mofi/assets/js/animation/wow/wow.min.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->

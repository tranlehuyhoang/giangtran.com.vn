...
<html lang="en">
  <head>
    ...
    <title>Error-404 | Mofi - Premium Admin Template By Pixelstrap</title>
    <!-- Google font-->
  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="error-wrapper">
        <div class="container"><img class="img-100" src="/mofi/assets/images/other-images/sad3.gif" alt="">
          ...
          <div><a class="btn btn-danger-gradien btn-lg" href="/" wire:navigate>BACK TO HOME PAGE</a></div>
        </div>
      </div>
      <!-- error-404 end      -->
    </div>

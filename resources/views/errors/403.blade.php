...
<html lang="en">
  <head>
    ...
    <title>Error-403 | Mofi - Premium Admin Template By Pixelstrap</title>
    <!-- Google font-->
  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="error-wrapper">
        <div class="container"><img class="img-100" src="/mofi/assets/images/other-images/sad2.gif" alt="">
          ...
          <div><a class="btn btn-success-gradien btn-lg" href="/" wire:navigate>BACK TO HOME PAGE</a></div>
        </div>
      </div>
      <!-- error-403 end-->
    </div>

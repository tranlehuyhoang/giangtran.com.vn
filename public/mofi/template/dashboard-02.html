...
<html lang="en">
  <head>
    ...
    <title>Project Dashboard | Mofi - Premium Admin Template By Pixelstrap</title>
    <!-- Google font-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      <div class="page-header row">
        ...
        <div class="col-4 col-xl-4 page-title">
          <h4 class="f-w-700">Project Dashboard</h4>
          <nav>
            <ol class="breadcrumb justify-content-sm-start align-items-center mb-0">
              <li class="breadcrumb-item"><a href="index.html"> <i data-feather="home"> </i></a></li>
              <li class="breadcrumb-item f-w-400">Dashboard</li>
              <li class="breadcrumb-item f-w-400 active">Project</li>
            </ol>
          </nav>
        </div>
        <!-- Page Header Start-->
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/1.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/2.png" alt=""></li>
                          ...
                          <tr>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/4.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/6.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/5.png" alt=""></li>
                              </ul>
                            </td>
                            <td> 11Feb23</td>
                            <td> 24Feb23</td>
                          ...
                          <tr>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/7.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/8.png" alt=""></li>
                                <li class="d-inline-block"> 
                                  <p class="bg-light rounded-circle">5+</p>
                                </li>
                              </ul>
                          ...
                          <tr>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/12.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/11.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/12.png" alt=""></li>
                              </ul>
                            </td>
                            <td> 05Sep23</td>
                      ...
                      <table class="table display" id="client-product" style="width:100%">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-2/svg-icon/1.png" alt=""></div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    <h5>Redesign Layout</h5></a>
                                  <p>Anna Catmire</p>
                                </div>
                              </div>
                            </td>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/1.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/12.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/3.png" alt=""></li>
                                <li class="d-inline-block"> 
                                  <p class="bg-light rounded-circle">5+</p>
                                </li>
                              </ul>
                          ...
                          <tr>
                            ...
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-2/svg-icon/2.png" alt=""></div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    <h5>Login & Sign Up Ui</h5></a>
                                  <p>John Elliot</p>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-2/svg-icon/3.png" alt=""></div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    <h5>Redesign CRM</h5></a>
                                  <p>Ashley Hart</p>
                                </div>
                              </div>
                            </td>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/7.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/8.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/9.png" alt=""></li>
                                <li class="d-inline-block"> 
                                  <p class="bg-light rounded-circle">5+</p>
                                </li>
                              </ul>
                          ...
                          <tr>
                            ...
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0"><img src="../assets/images/dashboard-2/svg-icon/4.png" alt=""></div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    <h5>Front-End Website</h5></a>
                                  <p>Dana Lemon</p>
                                </div>
                              </div>
                            </td>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/10.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/11.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/12.png" alt=""></li>
                              </ul>
                            </td>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                  <svg>
                                    <use href="../assets/svg/icon-sprite.svg#redesign"></use>
                                  </svg>
                                </div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    <h5>Square Dashboard</h5></a>
                                  <p>John Elliot</p>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                  <svg>
                                    <use href="../assets/svg/icon-sprite.svg#login-dashboard"></use>
                                  </svg>
                                </div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    <h5>Rules Post on Dribble</h5></a>
                                  <p>Dana Lemon</p>
                                </div>
                              </div>
                            </td>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/14.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/18.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/3.png" alt=""></li>
                                <li class="d-inline-block"> 
                                  <p class="bg-light rounded-circle">5+</p>
                                </li>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                  <svg>
                                    <use href="../assets/svg/icon-sprite.svg#redesign-CRM"></use>
                                  </svg>
                                </div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    <h5>Login & Sign Up UI</h5></a>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/6.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/18.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/19.png" alt=""></li>
                              </ul>
                            </td>
                            <td> 
                              <div class="progress-showcase">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                  <svg>
                                    <use href="../assets/svg/icon-sprite.svg#front-endwebsite"></use>
                                  </svg>
                                </div>
                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    <h5>Square dashboard</h5></a>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/11.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/12.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/17.png" alt=""></li>
                              </ul>
                            </td>
                            <td> 
                              <div class="progress-showcase">
                          ...
                          <tr>
                            ...
                            <td class="customers text-center social-group">
                              <ul>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/15.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/2.png" alt=""></li>
                                <li class="d-inline-block"><img class="img-30 rounded-circle" src="../assets/images/dashboard-2/user/19.png" alt=""></li>
                              </ul>
                            </td>
                ...
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <div class="header-top">
                      ...
                      <div class="dropdown icon-dropdown">
                        <button class="btn dropdown-toggle" id="userdropdown20" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown20"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a></div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <div class="header-top">
                      ...
                      <div class="dropdown icon-dropdown">
                        <button class="btn dropdown-toggle" id="userdropdown21" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                  ...
                  <div class="card-body designer-card">
                    <div>  
                      <div class="d-flex align-items-center gap-2"> 
                        <div class="flex-shrink-0"><img src="../assets/images/dashboard-2/user/18.png" alt="user"></div>
                        <div class="flex-grow-1"><a href="product-page.html">
                            <h5>Cronin Lewis</h5></a>
                ...
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <div class="header-top">
                      ...
                      <div class="dropdown icon-dropdown">
                        <button class="btn dropdown-toggle" id="userdropdown22" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                  ...
                  <div class="card-body designer-card">
                    <div>  
                      <div class="d-flex align-items-center gap-2"> 
                        <div class="flex-shrink-0"><img src="../assets/images/dashboard-2/user/17.png" alt="user"></div>
                        <div class="flex-grow-1"><a href="product-page.html">
                            <h5>Rau Foster</h5></a>
                ...
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <div class="header-top">
                      ...
                      <div class="dropdown icon-dropdown">
                        <button class="btn dropdown-toggle" id="userdropdown23" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown23"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a></div>
                      </div>
                    </div>
                  </div>
                  <div class="card-body designer-card">
                    <div>  
                      <div class="d-flex align-items-center gap-2"> 
                        <div class="flex-shrink-0"><img src="../assets/images/dashboard-2/user/19.png" alt="user"></div>
                        <div class="flex-grow-1"><a href="product-page.html">
                            <h5>Volkman Melisa</h5></a>
                ...
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <div class="header-top">
                      <h4>Today’s Tasks</h4>
                      <div class="dropdown icon-dropdown">
                        <button class="btn dropdown-toggle" id="userdropdown24" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown24"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a></div>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    <ul class="task-box"> 
                      <li class="bg-light"> 
                        <div class="d-flex align-items-center justify-content-between"> 
                          ...
                          <div class="dropdown icon-dropdown">
                            <button class="btn dropdown-toggle" id="userdropdown25" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown25"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a class="dropdown-item" href="#">Yearly </a></div>
                          </div>
                        </div>
                        <div class="d-flex align-items-center gap-2"> 
                          <div class="flex-shrink-0"><img src="../assets/images/dashboard-2/user/17.png" alt="user"></div>
                      ...
                      <li class="bg-light"> 
                        <div class="d-flex align-items-center justify-content-between"> 
                          ...
                          <div class="dropdown icon-dropdown">
                            <button class="btn dropdown-toggle" id="userdropdown26" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown26"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a class="dropdown-item" href="#">Yearly </a></div>
                          </div>
                        </div>
                        <div class="d-flex align-items-center gap-2"> 
                          <div class="flex-shrink-0">
                            <div class="customers social-group">
                              <ul>
                                <li class="d-inline-block"><img class="rounded-circle border-0" src="../assets/images/dashboard-2/user/13.png" alt=""></li>
                                <li class="d-inline-block"><img class="rounded-circle" src="../assets/images/dashboard-2/user/14.png" alt=""></li>
                              </ul>
                            </div>
                          </div>
                          <div class="flex-grow-1">
                      ...
                      <li class="bg-light"> 
                        <div class="d-flex align-items-center justify-content-between"> 
                          ...
                          <div class="dropdown icon-dropdown">
                            <button class="btn dropdown-toggle" id="userdropdown27" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown27"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a class="dropdown-item" href="#">Yearly </a></div>
                          </div>
                        </div>
                        <div class="d-flex align-items-center gap-2"> 
                          <div class="flex-shrink-0"><img src="../assets/images/dashboard-2/user/15.png" alt="user"></div>
                          <div class="flex-grow-1">
                            <p class="mb-0">Assigned to</p><a href="product-page.html">
                              <h5>Mahdi Gholizadeh</h5></a>
                          </div>
                        </div>
                      </li>
                    </ul>
                ...
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <div class="header-top">
                      ...
                      <div class="dropdown icon-dropdown">
                        <button class="btn dropdown-toggle" id="userdropdown28" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown28"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a></div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-6"> 
                        <div class="running-box"> 
                          <div class="d-flex align-items-center justify-content-between gap-2"> 
                            <div class="flex-grow-1"><a href="product-page.html">
                                <h5>Brooklyn Simmons</h5></a>
                              <p>Web Manager </p>
                            </div>
                            <div class="flex-shrink-0">
                              <div class="customers social-group">
                                <ul>
                                  <li class="d-inline-block"><img class="rounded-circle" src="../assets/images/dashboard-2/user/1.png" alt=""></li>
                                  <li class="d-inline-block"><img class="rounded-circle" src="../assets/images/dashboard-2/user/2.png" alt=""></li>
                                  <li class="d-inline-block"><img class="rounded-circle" src="../assets/images/dashboard-2/user/3.png" alt=""></li>
                                  <li class="d-inline-block"> 
                                    <p class="bg-light rounded-circle">5+</p>
                                  </li>
                                </ul>
                          ...
                          <div> 
                            <button class="btn bg-primary text-white">Upgrade Plan</button>
                            <button class="btn bg-secondary text-white">View Project</button>
                          </div>
                        </div>
                      </div>
                      <div class="col-6 running-events"><img src="../assets/images/dashboard-2/round.png" alt="">
                        <div> <img class="running-events-image" src="../assets/images/dashboard-2/events-bg.png" alt=""></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <div class="header-top">
                      ...
                      <div class="dropdown icon-dropdown">
                        <button class="btn dropdown-toggle" id="userdropdown29" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="icon-more-alt"></i></button>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown29"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a></div>
                      </div>
                    </div>
                  </div>
